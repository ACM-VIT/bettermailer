...
const TRASH_GROUPS: { label: string; emails: Email[] }[] = [
  {
    label: "Today",
    emails: [
      {
        ...
        snippet: "Refund will be processed soon",
        time: "12:10 PM",
      },
      {
        sender: "LinkedIn",
        subject: "Job alert expired",
    ...
    emails: [
      {
        ...
        snippet: "You have unread mentions",
        time: "Yesterday",
      },
      {
        sender: "YouTube",
        subject: "Video removed",
        snippet: "Content is no longer available",
        time: "Yesterday",
      },
    ],
  },
